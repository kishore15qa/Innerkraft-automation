...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Innerkraft/input_Password_password'), 'p4y+y39Ir5MxsruV+1WQBw==')

WebUI.click(findTestObject('Object Repository/Page_Innerkraft/button_Password_btn btn-primary disabledcur_f05e8b'))

WebUI.delay(15)

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Innerkraft/div_Load More_bg-primary text-white font-bo_3a368b'))
